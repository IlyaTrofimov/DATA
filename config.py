...
flags.DEFINE_list(
    'train_data_files', [DIR + 'train_1.tfrecords'],
...
flags.DEFINE_string(
    'valid_data_file', DIR + 'validation.tfrecords', 'Validation data in TFRecord format.')
flags.DEFINE_string(
    'test_data_file', DIR + 'test.tfrecords', 'Testing data in TFRecord format.')
flags.DEFINE_string(
    'sample_data_file', DIR + 'sample.tfrecords', 'Sampled batch data in TFRecord format.')
flags.DEFINE_string(
